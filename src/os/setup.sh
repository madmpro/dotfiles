...
declare -r GITHUB_REPOSITORY="madmpro/dotfiles"
...
logo() {
    ...
    color_print '                ___    ____  __  ___                  '
    color_print '     ____ ___  /   |  / __ \/  |/  / ____  _________  '
    color_print '    / __ `__ \/ /| | / / / / /|_/ / / __ \/ ___/ __ \ '
    color_print '   / / / / / / ___ |/ /_/ / /  / / / /_/ / /  / /_/ / '
    color_print '  /_/ /_/ /_/_/  |_/_____/_/  /_(_) .___/_/   \____/  '
    color_print '                                 /_/                  '
...
main() {
    ...
    find "${HOME}/.cron/" -type f -name "*.sh" -exec chmod +x \{\} \;
    ./install/crontab.sh
