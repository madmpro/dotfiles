...
# Enable Text Replacement in Apps
execute "defaults write -g WebAutomaticTextReplacementEnabled -bool true" \
      "Enable Text Replacement in Apps"

#execute "./macmoji.sh uninstall" \
#      "Dlete text replacements"

execute "./macmoji.sh restore" \
      "Install text replacements"
